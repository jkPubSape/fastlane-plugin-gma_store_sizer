...
require 'fastlane/plugin/gma_store_sizer/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-gma_store_sizer'
  spec.version       = Fastlane::GmaStoreSizer::VERSION
  spec.author        = 'Johnathon Karcz'
